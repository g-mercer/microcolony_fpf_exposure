...
theme(legend.position = "none", axis.title = element_text(size=18, face = "bold"), plot.title = element_text(hjust = 0.5, size = 24, face = "bold")) +
...
# save
 cairo_pdf(file = "./output/nectar_degradation_edited_axis.pdf",   # The directory you want to save the file in
     width = 8, # The width of the plot in inches
     height = 6) # The height of the plot in inches
...
```{r}
pollen_total_plot <- pollen_total_plot + theme(axis.title.x=element_blank(),
                                               axis.text.x=element_blank(),
                                               panel.grid.minor=element_blank(),
                                               panel.grid.major=element_blank(),
                                               plot.title = element_blank(),
...
cairo_pdf(file = "./output/pollen_degradation_edited_axis.pdf",   # The directory you want to save the file in
  width = 8, # The width of the plot in inches
  height = 6) # The height of the plot in inches
